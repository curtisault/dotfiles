;;; org-config.el --- Org mode + evil bindings -*- lexical-binding: t; -*-

;;; Commentary:
;; Org-mode configuration: notes/agenda paths, evil keybindings inside
;; org-mode-map, timer sound + notification override.
...
(use-package org
  ...
  ;; Override org notification to avoid D-Bus errors; show in minibuffer instead.
  (setq org-show-notification-handler
        (lambda (msg) (message "Timer finished: %s" msg)))

  ;; TAB cycling (fixes Evil conflict)
  ...
  ;; Structure editing with Meta + hjkl
